...
namespace SapSpcWinForms
{
    public sealed class KontrolniPlaniForm : Form
    {
        ...
        private void LoadKonsar()
        {
            ...
            if (_konsarGrid.Columns["mertraj"] != null) _konsarGrid.Columns["mertraj"].HeaderText = "èas za meritev";
        }
        ...
        private int ShowStKanalDialog(int initial)
        {
            ...
            })
            {
                ...
                var cancel = new Button { Text = "Preklièi", Left = 158, Width = 80, Top = 78, DialogResult = DialogResult.Cancel };
        ...
        private bool ShowVpisFrekDialog(ref int frk, ref int trj, ref bool prepisVse)
        {
            ...
            })
            {
                ...
                var lbl2 = new Label { Left = 12, Top = 54, AutoSize = true, Text = "Èas za meritev:" };
                ...
                var cancel = new Button { Text = "Preklièi", Left = 260, Width = 75, Top = 125, DialogResult = DialogResult.Cancel };
